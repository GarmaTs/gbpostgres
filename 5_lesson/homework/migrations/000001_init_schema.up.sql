...
ALTER TABLE snippets_tags
    ADD CONSTRAINT fk_snippets_tags_snippets FOREIGN KEY (snippet_id) REFERENCES snippets(id),
    ADD CONSTRAINT fk_snippets_tags_tags FOREIGN KEY (tag_id) REFERENCES tags(id);
